...
# python train_search_ts.py --batch_size 4 --epochs 50 --save FOO --note darts-PBC-50 --learning_rate 0.005
python train_search_ts.py --batch_size 4 --epochs 50 --save FOO --learning_rate 0.005
