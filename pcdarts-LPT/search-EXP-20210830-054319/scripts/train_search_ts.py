...
from model_search import Network # Trains the network in model_search
from architect_ts import Architect
from teacher import *
from teacher_update import *
#import custom_dataset2 as custom_dataset
...
def main():
  ...
  train_queue, valid_queue, external_queue = get_dataloaders(args.dataset_path, batch_size = args.batch_size, num_workers = 4, train_search = True)
...
def train(train_queue, valid_queue, external_queue,
  ...
  for step, data in enumerate(train_queue):
    ...
    input_external, target_external = data_external
    ...
    # print(input.shape,input_external.shape, target_external.shape)
