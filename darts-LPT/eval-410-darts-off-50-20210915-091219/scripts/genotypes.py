...
PDARTS_LPT_410_50 = Genotype(
        normal=[('avg_pool_3x3', 0), ('avg_pool_3x3', 1), ('avg_pool_3x3', 0), 
        ('dil_conv_3x3', 2), ('dil_conv_3x3', 0), ('avg_pool_3x3', 1), 
        ('avg_pool_3x3', 1), ('avg_pool_3x3', 4)], normal_concat=range(2, 6), 
        reduce=[('avg_pool_3x3', 0), ('skip_connect', 1), ('sep_conv_3x3', 0), 
        ('sep_conv_5x5', 2), ('dil_conv_3x3', 0), ('dil_conv_5x5', 3), 
        ('dil_conv_3x3', 1), ('sep_conv_3x3', 3)], reduce_concat=range(2, 6))
...
DARTS_OFF_PBC_50 = Genotype(
        ...
        ('sep_conv_5x5', 0), ('sep_conv_3x3', 0), ('skip_connect', 1), 
        ('skip_connect', 1), ('sep_conv_5x5', 0)], normal_concat=range(2, 6), 
        reduce=[('dil_conv_5x5', 1), ('skip_connect', 0), ('skip_connect', 0), 
        ('dil_conv_5x5', 2), ('skip_connect', 1), ('sep_conv_5x5', 2), 
        ('dil_conv_3x3', 1), ('dil_conv_3x3', 0)], reduce_concat=range(2, 6))
...
DARTS_TS_BC_50EPOCH = Genotype(
        ...
        ('sep_conv_3x3', 4)], reduce_concat=range(2, 6))

DARTS_TS_BC_25EPOCH = Genotype(
        normal=[('sep_conv_5x5', 1), 
        ('sep_conv_5x5', 0), ('sep_conv_3x3', 2), 
        ('sep_conv_5x5', 1), ('sep_conv_5x5', 1), 
        ('sep_conv_3x3', 3), ('sep_conv_5x5', 1), 
        ('sep_conv_3x3', 4)], normal_concat=range(2, 6), 
        reduce=[('sep_conv_5x5', 1), 
